...
import { deleteFromCart } from '../redux/features/cartListSlice';
                ...
                <div key={product.id} className='flex border rounded-md shadow-md p-1 w-full text-sm'>
                    ...
                    <div className='flex flex-col justify-between w-2/3 p-1 pl-3'>
                        <div className='flex justify-between w-full'>
                            ...
                            <button onClick={()=>{dispatch(deleteFromCart(product))}} className='text-orange-600'><FaTrashAlt size={20}/></button>
                        </div>
